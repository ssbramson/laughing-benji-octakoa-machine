  ...
  <main class="experience_detail-container">
    ...
    <section class="experience_detail-content" v-bind:class="[show ? blurClass : '', backClass]">
      ...
      <div class="experience_detail-client_logo-area">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="60px" width="200px" version="1.1" viewBox="0 0 559 168" class="experience_detail-client_logo">
      ...
      <article class="experience_detail-overview" role="contentinfo">
        ...
        <p class="experience_detail-client_description" rol2e="text">
          Spotify Limited provides a digital music-streaming service that gives on-demand access of songs on devices, computers, mobiles, tablets, and home entertainment systems. Its services allow subscribers to search and discover music collections of friends,
          artists, and celebrities; build a personal collection playlist; and share music.
        </p>
    ...
    <section class="next-experience-container">
      ...
      <div class="next-experience">
        ...
        <div class="next-experience-button">
          ...
          <a href="/thomson_reuters.html" class="next-experience-link" aria-label="">> Thomson Reuters</a>
        </div>
      </div>
